...
import Kstreams.AdWindow.org.example.serde.AppSerdes;
import Kstreams.AdWindow.org.example.types.SimpleValue;
import Kstreams.AdWindow.org.example.types.WindowAgg;
...
public class AdTumblingWindowFin {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, SimpleValue> KS0 = streamsBuilder.stream(AppConfigs.adTopicName,
