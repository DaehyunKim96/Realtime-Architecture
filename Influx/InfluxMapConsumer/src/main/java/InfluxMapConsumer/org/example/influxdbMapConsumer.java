package InfluxMapConsumer.org.example;

import InfluxMapConsumer.org.example.serde.JsonDeserializer;
import InfluxMapConsumer.org.example.types.WinLog;
...
public class influxdbMapConsumer {
    ...
    public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "map-tmp");
